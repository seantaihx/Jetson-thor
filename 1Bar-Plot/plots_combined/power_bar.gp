...
plot 'combined_transformers_vs_vllm.dat' using 10:xtic(1) title 'JT vLLM', \
     '' using 11:xtic(1) title 'JT Transformers', \
     '' using 12:xtic(1) title 'IC2 vLLM', \
     '' using 13:xtic(1) title 'IC2 Transformers'
