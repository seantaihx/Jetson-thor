...
set output 'utilization_combined.png'
plot 'combined_transformers_vs_vllm.dat' using 6:xtic(1) title 'JT vLLM', \
     '' using 7:xtic(1) title 'JT Transformers', \
     '' using 8:xtic(1) title 'IC2 vLLM', \
     '' using 9:xtic(1) title 'IC2 Transformers'
